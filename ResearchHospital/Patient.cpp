...
Patient::Patient(string first_t, string last_t, string ssn_t, vector<vector<string>> patientQueue){
  first = first_t;
  last = last_t;
  ssn = ssn_t;
...
vector<vector<string>> Patient::GetPatientQueue(){return patientQueue;}
...
void Patient::SetPatientQueue(vector<vector<string>> patientQueue_t){patientQueue = patientQueue_t;}
